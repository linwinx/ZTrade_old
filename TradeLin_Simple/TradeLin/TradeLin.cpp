...
//	GetMultiAccountsQuotesDelegate GetMultiAccountsQuotes = (GetMultiAccountsQuotesDelegate)GetProcAddress(HMODULE1, "GetMultiAccountsQuotes");
	...
	//登录帐号
	//int ClientID = Logon("58.249.119.236", 7709, "6.20", 0, "97720035", "97720035", "781813", "", ErrInfo); //招商行情
	//int ClientID = Logon("58.251.16.167", 443, "6.20", 0, "97720035", "97720035", "781813", "", ErrInfo); //招商交易
	int ClientID = Logon("202.69.19.56", 7708, "6.20", 0, "309619426390", "309619426390", "781813", "", ErrInfo); //平安交易
	...
	QueryData(ClientID, 1, Result, ErrInfo);//查询资金
		...
		//QueryDatas(ClientID, Categorys, 5, Results, ErrInfos);//查询资金
		//QueryData(ClientID2, 0, Result, ErrInfo);//第二个帐号,查询资金
		//cout << Result << "| " << ErrInfo;
